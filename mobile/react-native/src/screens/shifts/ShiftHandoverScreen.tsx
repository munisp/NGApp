 ...
 * Shift handover notes — create and read
 */
export default function ShiftHandoverScreen() {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>ShiftHandover</Text>
      <Text style={styles.subtitle}>Full implementation mirrors PWA — uses trpc.shiftHandover.list</Text>
    </View>
  );
}
