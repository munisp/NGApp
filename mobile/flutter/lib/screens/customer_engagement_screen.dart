...
class _CustomerEngagementScreenState extends State<CustomerEngagementScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'campaign', 'channel', 'reach', 'conversion'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'campaign', 'channel', 'reach', 'conversion'];
    final labels = ['ID', 'Campaign', 'Channel', 'Reach', 'Conversion'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Customer Engagement'),
