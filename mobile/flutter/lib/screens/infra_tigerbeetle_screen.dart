...
class _InfraTigerbeetleScreenState extends State<InfraTigerbeetleScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'cluster', 'accounts', 'transfers'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'cluster', 'accounts', 'transfers'];
    final labels = ['ID', 'Cluster', 'Accounts', 'Transfers/s'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Infra: TigerBeetle'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Infra: TigerBeetle')),
