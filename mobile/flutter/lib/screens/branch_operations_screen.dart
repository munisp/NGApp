...
class _BranchOperationsScreenState extends State<BranchOperationsScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'name', 'location', 'staff', 'status'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'name', 'location', 'staff', 'status'];
    final labels = ['ID', 'Branch', 'Location', 'Staff', 'Status'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Branch Operations'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Branch Operations')),
