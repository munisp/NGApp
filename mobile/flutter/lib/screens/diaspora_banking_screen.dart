...
class _DiasporaBankingScreenState extends State<DiasporaBankingScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'name', 'country', 'type', 'balance'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'name', 'country', 'type', 'balance'];
    final labels = ['ID', 'Name', 'Country', 'Type', 'Balance'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Diaspora Banking'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Diaspora Banking')),
