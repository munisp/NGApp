...
class _ChannelManagementScreenState extends State<ChannelManagementScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'name', 'users', 'txns', 'status'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'name', 'users', 'txns', 'status'];
    final labels = ['ID', 'Channel', 'Users', 'Txns/Day', 'Status'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Channel Management'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Channel Management')),
