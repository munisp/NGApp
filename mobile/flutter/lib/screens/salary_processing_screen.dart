...
class _SalaryProcessingScreenState extends State<SalaryProcessingScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'company', 'employees', 'total', 'status'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'company', 'employees', 'total', 'status'];
    final labels = ['ID', 'Company', 'Staff', 'Total', 'Status'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Salary Processing'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Salary Processing')),
