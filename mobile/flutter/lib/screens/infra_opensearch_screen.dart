...
class _InfraOpensearchScreenState extends State<InfraOpensearchScreen> {
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'index', 'docs', 'size'];
    final labels = ['ID', 'Index', 'Documents', 'Size'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Infra: OpenSearch'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Infra: OpenSearch')),
