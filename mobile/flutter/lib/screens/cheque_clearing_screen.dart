...
class _ChequeClearingScreenState extends State<ChequeClearingScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'drawer', 'amount', 'bank', 'status'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'drawer', 'amount', 'bank', 'status'];
    final labels = ['ID', 'Drawer', 'Amount', 'Bank', 'Status'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Cheque Clearing'),
