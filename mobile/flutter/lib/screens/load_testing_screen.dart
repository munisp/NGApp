...
class _LoadTestingScreenState extends State<LoadTestingScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'scenario', 'requests', 'success', 'p99'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'scenario', 'requests', 'success', 'p99'];
    final labels = ['ID', 'Scenario', 'Requests', 'Success', 'P99 ms'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Load Testing'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Load Testing')),
