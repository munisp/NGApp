...
class _ExamManagementScreenState extends State<ExamManagementScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'regulator', 'type', 'date', 'status'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'regulator', 'type', 'date', 'status'];
    final labels = ['ID', 'Regulator', 'Type', 'Date', 'Status'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Regulatory Exams'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Regulatory Exams')),
