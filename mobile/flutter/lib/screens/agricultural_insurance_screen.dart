...
class _AgriculturalInsuranceScreenState extends State<AgriculturalInsuranceScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'farmer', 'crop', 'coverage', 'status'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'farmer', 'crop', 'coverage', 'status'];
    final labels = ['ID', 'Farmer', 'Crop', 'Coverage', 'Status'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Agricultural Insurance'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Agricultural Insurance')),
