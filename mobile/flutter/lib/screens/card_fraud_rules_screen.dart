...
class _CardFraudRulesScreenState extends State<CardFraudRulesScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'name', 'condition', 'action', 'status'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'name', 'condition', 'action', 'status'];
    final labels = ['ID', 'Rule', 'Condition', 'Action', 'Status'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Card Fraud Rules'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Card Fraud Rules')),
