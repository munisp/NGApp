...
class _WorkflowInstancesScreenState extends State<WorkflowInstancesScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'definition', 'step', 'status'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'definition', 'step', 'status'];
    final labels = ['ID', 'Definition', 'Current Step', 'Status'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Workflow Instances'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Workflow Instances')),
