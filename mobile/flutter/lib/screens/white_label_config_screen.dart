...
class _WhiteLabelConfigScreenState extends State<WhiteLabelConfigScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'partner', 'brand', 'modules', 'status'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'partner', 'brand', 'modules', 'status'];
    final labels = ['ID', 'Partner', 'Brand', 'Modules', 'Status'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'White Label Config'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('White Label Config')),
