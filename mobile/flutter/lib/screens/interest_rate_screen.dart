...
class _InterestRateScreenState extends State<InterestRateScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'name', 'baseRate', 'spread', 'effective'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'name', 'baseRate', 'spread', 'effective'];
    final labels = ['ID', 'Product', 'Base', 'Spread', 'Effective'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Interest Rate Config'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Interest Rate Config')),
