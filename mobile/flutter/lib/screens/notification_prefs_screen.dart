...
class _NotificationPrefsScreenState extends State<NotificationPrefsScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['channel', 'txnAlerts', 'marketing', 'security'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['channel', 'txnAlerts', 'marketing', 'security'];
    final labels = ['Channel', 'Txn Alerts', 'Marketing', 'Security'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Notification Prefs'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Notification Prefs')),
