...
class _EmbeddedFinanceScreenState extends State<EmbeddedFinanceScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'name', 'industry', 'apiCalls', 'status'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'name', 'industry', 'apiCalls', 'status'];
    final labels = ['ID', 'Partner', 'Industry', 'API Calls', 'Status'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Embedded Finance'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Embedded Finance')),
