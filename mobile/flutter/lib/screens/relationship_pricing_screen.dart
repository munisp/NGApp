...
class _RelationshipPricingScreenState extends State<RelationshipPricingScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'customer', 'tier', 'discount'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'customer', 'tier', 'discount'];
    final labels = ['ID', 'Customer', 'Tier', 'Discount'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Relationship Pricing'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Relationship Pricing')),
