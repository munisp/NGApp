...
class _WorkflowDefinitionsScreenState extends State<WorkflowDefinitionsScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'name', 'steps', 'status'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'name', 'steps', 'status'];
    final labels = ['ID', 'Definition', 'Steps', 'Status'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Workflow Definitions'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Workflow Definitions')),
