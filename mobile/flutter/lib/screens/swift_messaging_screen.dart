...
class _SwiftMessagingScreenState extends State<SwiftMessagingScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'type', 'sender', 'amount', 'status'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'type', 'sender', 'amount', 'status'];
    final labels = ['ID', 'Type', 'Sender', 'Amount', 'Status'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'SWIFT Messaging'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('SWIFT Messaging')),
