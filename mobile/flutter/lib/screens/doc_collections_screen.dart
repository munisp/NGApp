...
class _DocCollectionsScreenState extends State<DocCollectionsScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'customer', 'docs', 'complete', 'status'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'customer', 'docs', 'complete', 'status'];
    final labels = ['ID', 'Customer', 'Documents', 'Complete', 'Status'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Document Collections'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Document Collections')),
