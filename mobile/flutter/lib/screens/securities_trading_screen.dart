...
class _SecuritiesTradingScreenState extends State<SecuritiesTradingScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'security', 'exchange', 'side', 'qty', 'price', 'status'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'security', 'exchange', 'side', 'qty', 'price', 'status'];
    final labels = ['ID', 'Security', 'Exchange', 'Side', 'Qty', 'Price', 'Status'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Securities Trading'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Securities Trading')),
