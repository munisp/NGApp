...
class _DormancyMgmtScreenState extends State<DormancyMgmtScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['account', 'customer', 'lastActivity', 'balance', 'status'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['account', 'customer', 'lastActivity', 'balance', 'status'];
    final labels = ['Account', 'Customer', 'Last Activity', 'Balance', 'Status'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Dormancy Management'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Dormancy Management')),
