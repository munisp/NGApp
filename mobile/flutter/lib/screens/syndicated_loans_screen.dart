...
class _SyndicatedLoansScreenState extends State<SyndicatedLoansScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'borrower', 'total', 'ourShare', 'status'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'borrower', 'total', 'ourShare', 'status'];
    final labels = ['ID', 'Borrower', 'Total', 'Our Share', 'Status'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Syndicated Loans'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Syndicated Loans')),
