...
class _RegulatoryAutomationScreenState extends State<RegulatoryAutomationScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'name', 'framework', 'status'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'name', 'framework', 'status'];
    final labels = ['ID', 'Return', 'Framework', 'Status'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Regulatory Automation'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Regulatory Automation')),
