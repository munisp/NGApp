...
class _EscrowScreenState extends State<EscrowScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'parties', 'amount', 'purpose', 'status'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'parties', 'amount', 'purpose', 'status'];
    final labels = ['ID', 'Parties', 'Amount', 'Purpose', 'Status'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Escrow Services'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Escrow Services')),
