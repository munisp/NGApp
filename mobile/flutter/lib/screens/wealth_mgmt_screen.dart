...
class _WealthMgmtScreenState extends State<WealthMgmtScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'client', 'aum', 'strategy', 'ytdReturn'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'client', 'aum', 'strategy', 'ytdReturn'];
    final labels = ['ID', 'Client', 'AUM', 'Strategy', 'YTD'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Wealth Management'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Wealth Management')),
