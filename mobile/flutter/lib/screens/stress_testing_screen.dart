...
class _StressTestingScreenState extends State<StressTestingScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'scenario', 'impact', 'car', 'status'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'scenario', 'impact', 'car', 'status'];
    final labels = ['ID', 'Scenario', 'Impact', 'CAR After', 'Status'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Stress Testing'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Stress Testing')),
