...
class _MessagingGatewayScreenState extends State<MessagingGatewayScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'provider', 'type', 'volume', 'status'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'provider', 'type', 'volume', 'status'];
    final labels = ['ID', 'Provider', 'Type', 'Volume/Day', 'Status'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Messaging Gateway'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Messaging Gateway')),
