...
class _ContingentLiabilitiesScreenState extends State<ContingentLiabilitiesScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'type', 'amount', 'probability', 'status'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'type', 'amount', 'probability', 'status'];
    final labels = ['ID', 'Type', 'Amount', 'Probability', 'Status'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Contingent Liabilities'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Contingent Liabilities')),
