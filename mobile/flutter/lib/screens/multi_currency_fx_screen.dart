...
class _MultiCurrencyFxScreenState extends State<MultiCurrencyFxScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['base', 'quote', 'buy', 'sell', 'source'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['base', 'quote', 'buy', 'sell', 'source'];
    final labels = ['Base', 'Quote', 'Buy', 'Sell', 'Source'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Multi-Currency FX'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Multi-Currency FX')),
