...
class _EsusuScreenState extends State<EsusuScreen> {
  ...
  void _showCreateDialog() {
    final keys = ['id', 'name', 'members', 'contribution', 'cycle'];
  ...
  void _showDetail(Map<String, String> item) {
    final keys = ['id', 'name', 'members', 'contribution', 'cycle'];
    final labels = ['ID', 'Group', 'Members', 'Contribution', 'Cycle'];
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title: Text(item[keys[0]] ?? 'Esusu (ROSCA)'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Esusu (ROSCA)')),
