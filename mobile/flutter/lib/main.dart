...
void main() async {
  ...
  runApp(const FiftyFourBankApp());
}

class FiftyFourBankApp extends StatelessWidget {
  const FiftyFourBankApp({super.key});
  @override
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("54Bank")),
      drawer: Drawer(
        child: ListView(
          padding: EdgeInsets.zero,
          children: [
            const DrawerHeader(decoration: BoxDecoration(color: Color(0xFF1B5E20)), child: Text("54Bank", style: TextStyle(color: Colors.white, fontSize: 24))),
