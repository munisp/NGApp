          ...
          children: [
            DrawerHeader(
              ...
              child: const Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.end, children: [
                ...
                SizedBox(height: 4),
                Text('Core Banking Platform', style: TextStyle(color: Colors.white70, fontSize: 14)),
              ]),
            ),
            ...
            ListTile(title: const Text('Customer 360'), onTap: () => Navigator.pushNamed(context, '/customer-360')),
            ...
            ListTile(title: const Text('Grafana Dashboards'), onTap: () => Navigator.pushNamed(context, '/grafana-dashboards')),
            ListTile(title: const Text('Ha Middleware'), onTap: () => Navigator.pushNamed(context, '/ha-middleware')),
            ListTile(title: const Text('Ha Services'), onTap: () => Navigator.pushNamed(context, '/ha-services')),
            ListTile(title: const Text('Ha Zones'), onTap: () => Navigator.pushNamed(context, '/ha-zones')),
            ...
            ListTile(title: const Text('Keycloak Idps'), onTap: () => Navigator.pushNamed(context, '/keycloak-idps')),
            ...
            ListTile(title: const Text('Mojaloop Ilp Packets'), onTap: () => Navigator.pushNamed(context, '/mojaloop-ilp-packets')),
            ...
            ListTile(title: const Text('Mojaloop Tb Bridge Configs'), onTap: () => Navigator.pushNamed(context, '/mojaloop-tb-bridge-configs')),
            ListTile(title: const Text('Mojaloop Tb Bridge Entries'), onTap: () => Navigator.pushNamed(context, '/mojaloop-tb-bridge-entries')),
            ...
            ListTile(title: const Text('Otel Configs'), onTap: () => Navigator.pushNamed(context, '/otel-configs')),
            ...
            ListTile(title: const Text('Prometheus Metrics'), onTap: () => Navigator.pushNamed(context, '/prometheus-metrics')),
            ListTile(title: const Text('Proxy Routes'), onTap: () => Navigator.pushNamed(context, '/proxy-routes')),
            ...
            ListTile(title: const Text('Service Registry'), onTap: () => Navigator.pushNamed(context, '/service-registry')),
            ...
            ListTile(title: const Text('Tb Pg Balance Cache Configs'), onTap: () => Navigator.pushNamed(context, '/tb-pg-balance-cache-configs')),
            ListTile(title: const Text('Tb Pg Balance Cache Entries'), onTap: () => Navigator.pushNamed(context, '/tb-pg-balance-cache-entries')),
            ListTile(title: const Text('Tb Pg Reconciliation Rules'), onTap: () => Navigator.pushNamed(context, '/tb-pg-reconciliation-rules')),
            ListTile(title: const Text('Tb Pg Reconciliation Runs'), onTap: () => Navigator.pushNamed(context, '/tb-pg-reconciliation-runs')),
            ListTile(title: const Text('Tb Pg Saga Definitions'), onTap: () => Navigator.pushNamed(context, '/tb-pg-saga-definitions')),
            ListTile(title: const Text('Tb Pg Saga Executions'), onTap: () => Navigator.pushNamed(context, '/tb-pg-saga-executions')),
            ListTile(title: const Text('Tb Pg Sync Configs'), onTap: () => Navigator.pushNamed(context, '/tb-pg-sync-configs')),
            ListTile(title: const Text('Tb Pg Sync Events'), onTap: () => Navigator.pushNamed(context, '/tb-pg-sync-events')),
