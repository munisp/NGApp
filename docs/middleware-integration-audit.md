...
| `TERMII_API_KEY` | *(optional)* | SMS delivery (graceful fallback to console.log) |
| `VAPID_PUBLIC_KEY` | *(bundled default)* | Web push public key |
| `VAPID_PRIVATE_KEY` | *(bundled default)* | Web push private key |

---

*Document generated from live codebase inspection of `/home/ubuntu/pos-shell-demo/` and `/home/ubuntu/platform/platform/middleware/`. All integration statuses reflect the state as of the Phase 84 checkpoint.*
