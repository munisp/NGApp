    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500">Powered by Wise - Fast, low-cost transfers</p>
        </div>
      ...
      {activeTab === 'send' && (
        <form onSubmit={handleTransfer} className="space-y-4">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm space-y-4">
            <h2 className="text-lg font-semibold text-gray-900">You Send</h2>
            ...
            {quote && (
              <>
                ...
                <div className="border-t pt-4">
                  <h2 className="text-lg font-semibold text-gray-900 mb-3">Recipient Gets</h2>
                  <div className="flex gap-3">
                    <div className="flex-1">
                      <div className="input-field text-2xl font-bold bg-gray-50">
      ...
      {activeTab === 'recipients' && (
        <div className="space-y-4">
          <div className="flex justify-between items-center">
            <h2 className="text-lg font-semibold text-gray-900">Your Recipients</h2>
              ...
              {recipients.map((recipient) => (
                <div key={recipient.id} className="bg-white rounded-xl p-4 shadow-sm flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-400">{recipient.country}</p>
                  </div>
