...
const Dashboard: React.FC = () => {
  ...
  const recentTransactions = [
    { id: 1, type: 'sent', name: 'John Doe', amount: 50000, currency: 'NGN', date: '2024-01-15', icon: 'M5 10l7-7m0 0l7 7m-7-7v18' },
    { id: 2, type: 'received', name: 'Jane Smith', amount: 25000, currency: 'NGN', date: '2024-01-14', icon: 'M19 14l-7 7m0 0l-7-7m7 7V3' },
    { id: 3, type: 'airtime', name: 'MTN Airtime', amount: 2000, currency: 'NGN', date: '2024-01-13', icon: 'M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z' },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-indigo-600 via-indigo-700 to-violet-700 rounded-2xl p-6 text-white relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <h2 className="text-3xl font-bold mt-1 tracking-tight">NGN 250,000.00</h2>
