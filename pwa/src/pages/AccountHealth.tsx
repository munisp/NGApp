  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500">Monitor your account status and limits</p>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div className="pt-2 border-t">
              <div className="flex justify-between">
                <span className="text-gray-500">Single Transaction Limit</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 bg-gray-50 rounded-xl">
              ...
              <span className={`text-xs px-2 py-1 rounded-full ${
                compliance.kycStatus === 'verified' ? 'bg-green-100 text-green-700' :
                compliance.kycStatus === 'pending' ? 'bg-yellow-100 text-yellow-700' :
                compliance.kycStatus === 'rejected' ? 'bg-red-100 text-red-700' :
            ...
            <div className="p-4 bg-gray-50 rounded-xl">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className={`font-bold text-2xl ${
                  compliance.amlStatus === 'clear' ? 'text-green-600' :
                  compliance.amlStatus === 'review' ? 'text-yellow-600' :
                  'text-red-600'
                }`}>
              ...
              <span className={`text-xs px-2 py-1 rounded-full ${
                compliance.amlStatus === 'clear' ? 'bg-green-100 text-green-700' :
                compliance.amlStatus === 'review' ? 'bg-yellow-100 text-yellow-700' :
            ...
            <div className="p-4 bg-gray-50 rounded-xl">
              ...
              <p className="font-medium text-gray-900 mt-1">{formatDate(compliance.lastVerification)}</p>
            </div>

            <div className="p-4 bg-gray-50 rounded-xl">
              <span className="text-gray-500">Next Review Date</span>
              <p className="font-medium text-gray-900 mt-1">{formatDate(compliance.nextReviewDate)}</p>
            </div>
          </div>
        </div>
      )}
      ...
      {/* Quick Actions */}
      <div className="bg-white rounded-2xl p-6 shadow-sm">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Improve Your Account Health</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <h3 className="font-medium text-gray-900">Upgrade KYC</h3>
            <p className="text-sm text-gray-500 mt-1">Increase your transaction limits</p>
          </a>
          ...
          >
            ...
            <p className="text-sm text-gray-500 mt-1">Add missing information</p>
          </a>
        </div>
      </div>
    </div>
