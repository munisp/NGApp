...
setup_logging("multi-ocr-service")
...
app = FastAPI(
    title="Multi-OCR Service",
    description="Multi-OCR Service for Agent Banking Platform",
    version="1.0.0"
)
...
async def root():
    return {
        "service": "multi-ocr-service",
        "description": "Multi-OCR Service",
        "version": "1.0.0",
        "port": 8157,
        "status": "operational"
    }
