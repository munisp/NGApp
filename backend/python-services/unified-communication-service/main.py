...
"""
Unified Communication Service Service
Port: 8139
"""
...
setup_logging("unified-communication-service")
...
app = FastAPI(
    ...
    description="Unified Communication Service for Agent Banking Platform",
    version="1.0.0"
)
...
async def root():
    return {
        ...
        "description": "Unified Communication Service",
        "version": "1.0.0",
        "port": 8139,
        "status": "operational"
    }
