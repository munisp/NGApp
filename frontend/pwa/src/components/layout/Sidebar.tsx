...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 flex h-screen w-16 flex-col items-center border-r border-surface-700 bg-surface-800 py-4 lg:w-56">
      {/* Logo */}
      <div className="mb-8 flex items-center gap-2 px-4">
        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-brand-600 text-sm font-bold">
          NX
        </div>
        <span className="hidden text-sm font-bold lg:block">NEXCOM</span>
      </div>
      ...
      <div className="px-4 pb-2">
        <div className="flex items-center gap-2">
          ...
          <span className="hidden text-xs text-gray-500 lg:block">Connected</span>
        </div>
      </div>
    </aside>
  );
