  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.pinDisplay}>
        {[0, 1, 2, 3].map(i => (
          <View key={i} style={[styles.pinDot, (step === 'enter' ? pin : confirmPin).length > i && styles.pinDotFilled]} />
        ))}
      </View>
...
const styles = StyleSheet.create({
  ...
  pinDot: { width: 16, height: 16, borderRadius: 8, borderWidth: 2, borderColor: '#667eea', marginHorizontal: 10 },
