  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="bg-white rounded-lg border p-4"><div className="flex items-center gap-2 text-sm text-gray-500"><Users className="h-4 w-4" /> Total Referrals</div><div className="text-2xl font-bold mt-1">{referrals.length}</div></div>
        <div className="bg-white rounded-lg border p-4"><div className="flex items-center gap-2 text-sm text-gray-500"><TrendingUp className="h-4 w-4" /> Active</div><div className="text-2xl font-bold mt-1 text-green-600">{referrals.filter(r => r.status === 'active').length}</div></div>
