  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-lg border p-4"><div className="text-2xl font-bold text-blue-600">{windows.filter(w => w.status === 'scheduled').length}</div><div className="text-sm text-gray-500">Upcoming Windows</div></div>
        <div className="bg-white rounded-lg border p-4"><div className="text-2xl font-bold text-green-600">{windows.filter(w => w.status === 'completed').length}</div><div className="text-sm text-gray-500">Completed (30d)</div></div>
      </div>
