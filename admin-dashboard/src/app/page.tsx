...
const OnboardingPortal = dynamic(() => import('@/components/onboarding/OnboardingPortal').then(m => ({ default: m.OnboardingPortal })), { loading: () => <PageSpinner /> });
const ApplicantPortal = dynamic(() => import('@/components/onboarding/ApplicantPortal').then(m => ({ default: m.ApplicantPortal })), { loading: () => <PageSpinner /> });
const BulkOnboarding = dynamic(() => import('@/components/onboarding/BulkOnboarding').then(m => ({ default: m.BulkOnboarding })), { loading: () => <PageSpinner /> });
const IntegrationTestingPortal = dynamic(() => import('@/components/onboarding/IntegrationTestingPortal').then(m => ({ default: m.IntegrationTestingPortal })), { loading: () => <PageSpinner /> });
const SLADashboard = dynamic(() => import('@/components/onboarding/SLADashboard').then(m => ({ default: m.SLADashboard })), { loading: () => <PageSpinner /> });
const TemplateCloning = dynamic(() => import('@/components/onboarding/TemplateCloning').then(m => ({ default: m.TemplateCloning })), { loading: () => <PageSpinner /> });
const ReviewerAssignmentRules = dynamic(() => import('@/components/onboarding/ReviewerAssignmentRules').then(m => ({ default: m.ReviewerAssignmentRules })), { loading: () => <PageSpinner /> });
const KYCVerificationPortal = dynamic(() => import('@/components/kyc/KYCVerificationPortal').then(m => ({ default: m.KYCVerificationPortal })), { loading: () => <PageSpinner /> });
const ApplicantKYCPortal = dynamic(() => import('@/components/kyc/ApplicantKYCPortal').then(m => ({ default: m.ApplicantKYCPortal })), { loading: () => <PageSpinner /> });
const KYBVerificationPortal = dynamic(() => import('@/components/kyb/KYBVerificationPortal').then(m => ({ default: m.KYBVerificationPortal })), { loading: () => <PageSpinner /> });
const UserManagement = dynamic(() => import('@/components/users/UserManagement').then(m => ({ default: m.UserManagement })), { loading: () => <PageSpinner /> });
const JourneyDashboard = dynamic(() => import('@/components/journey-dashboard/JourneyDashboard'), { loading: () => <PageSpinner /> });
const JourneyAnalytics = dynamic(() => import('@/components/journey-analytics/JourneyAnalytics'), { loading: () => <PageSpinner /> });
