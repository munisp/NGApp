...
export default function A2PCompliance() {
  const { data: _apiData, isLoading: _apiLoading, isUsingFallback } = useApiData('a2pcompliance', () => apiClient.dashboard.metrics(), { fallback: rows })
