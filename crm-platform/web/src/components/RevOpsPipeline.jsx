...
const RevOpsPipeline = () => {
  ...
  return (
    <div role="region" aria-label="RevOpsPipeline">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Unified Revenue Pipeline</h1>
