      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-16 right-0 sm:right-4 w-[calc(100vw-2rem)] sm:w-96 bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 z-50 max-h-[80vh] flex flex-col"
          >
            {/* Header */}
