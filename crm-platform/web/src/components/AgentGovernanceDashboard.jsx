...
const AgentGovernanceDashboard = () => {
  ...
  return (
    <div role="region" aria-label="AgentGovernanceDashboard">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Agent Governance</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-1">Permission tiers, audit logs, and kill switch for AI agents</p>
        </div>
        <FallbackBadge />
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <p className="text-gray-600 dark:text-gray-400">Permission tiers, audit logs, and kill switch for AI agents. Connected to backend services for real-time data when APIs are running.</p>
      </div>
    </div>
  )
}
