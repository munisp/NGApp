...
import { trainingCourses, trainingEnrollments, agents } from "../../drizzle/schema";
import { eq, desc, and, sql, gte } from "drizzle-orm";
import { TRPCError } from "@trpc/server";
import { getAgentFromCookie } from "../middleware/agentAuth";

const BADGES = [
  { id: "first_tx", name: "First Transaction", description: "Complete your first transaction", xp: 50 },
  { id: "speed_demon", name: "Speed Demon", description: "Process 10 transactions in one hour", xp: 100 },
  { id: "high_roller", name: "High Roller", description: "Process a transaction over N100,000", xp: 150 },
  { id: "consistent", name: "Consistency King", description: "Transact every day for 7 days", xp: 200 },
  { id: "offline_pro", name: "Offline Pro", description: "Successfully sync 20+ offline transactions", xp: 200 },
  { id: "voice_master", name: "Voice Master", description: "Complete 10 voice-initiated transactions", xp: 150 },
  { id: "bill_buster", name: "Bill Buster", description: "Process 50 bill payments", xp: 250 },
  { id: "mobile_maven", name: "Mobile Maven", description: "Process 100 mobile money transactions", xp: 300 },
  { id: "mentor", name: "Mentor", description: "Transfer float to 5 different agents", xp: 250 },
  { id: "global_agent", name: "Global Agent", description: "Complete a cross-border remittance", xp: 300 },
];
