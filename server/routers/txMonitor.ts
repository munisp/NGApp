...
export const txMonitorRouter = router({
  ...
  getAlerts: publicProcedure
    ...
    .query(async ({ input }) => {
      const alerts = [
        { id: "ALT-001", ruleId: "RULE-001", severity: "critical", agentId: "AGT-010", amount: 2500000, status: "open", createdAt: "2024-06-01T14:30:00Z", description: "High value transaction detected" },
        { id: "ALT-002", ruleId: "RULE-002", severity: "high", agentId: "AGT-015", amount: 150000, status: "open", createdAt: "2024-06-01T15:00:00Z", description: "Rapid transactions detected" },
        { id: "ALT-003", ruleId: "RULE-007", severity: "critical", agentId: "AGT-020", amount: 4800000, status: "acknowledged", createdAt: "2024-06-01T16:00:00Z", description: "Structuring pattern detected" },
        { id: "ALT-004", ruleId: "RULE-005", severity: "low", agentId: "AGT-025", amount: 50000, status: "resolved", createdAt: "2024-06-02T02:00:00Z", description: "Transaction at unusual hours" },
      ];
      let filtered = alerts;
  ...
  acknowledgeAlert: publicProcedure
    ...
    .mutation(async ({ input }) => {
      return { success: true, alertId: input.alertId, status: "acknowledged", acknowledgedAt: new Date().toISOString() };
    }),

  resolveAlert: publicProcedure
    .input(z.object({ alertId: z.string(), resolution: z.string() }))
    .mutation(async ({ input }) => {
      return { success: true, alertId: input.alertId, status: "resolved", resolution: input.resolution, resolvedAt: new Date().toISOString() };
    }),
  ...
  getDashboard: publicProcedure.query(async () => {
    return {
      ...
      rulesCount: 8,
      recentAlerts: [
        { id: "ALT-001", severity: "critical", description: "High value transaction", createdAt: "2024-06-01T14:30:00Z" },
        { id: "ALT-002", severity: "high", description: "Rapid transactions", createdAt: "2024-06-01T15:00:00Z" },
      ],
    };
  }),
