...
const SEEDED_RULES = [
  { id: "thr_001", metricId: "tx_volume", operator: "gt", value: 10000, severity: "critical", status: "active" },
  { id: "thr_002", metricId: "tx_failed", operator: "gte", value: 100, severity: "warning", status: "active" },
  { id: "thr_003", metricId: "fraud_score", operator: "gt", value: 80, severity: "critical", status: "active" },
  { id: "thr_004", metricId: "settlement_delay", operator: "gt", value: 3600, severity: "warning", status: "active" },
  { id: "thr_005", metricId: "api_latency", operator: "gt", value: 5000, severity: "critical", status: "active" },
  { id: "thr_006", metricId: "agent_churn", operator: "gt", value: 5, severity: "warning", status: "active" },
];
...
export const dataThresholdAlertsRouter = router({
  metrics: protectedProcedure.query(async () => {
    return [
      ...
      { id: "tx_amount", category: "transactions", label: "Transaction Amount" },
      ...
      { id: "settlement_failures", category: "finance", label: "Settlement Failures" },
      ...
      { id: "tx_reversal_rate", category: "transactions", label: "Reversal Rate" },
    ];
  }),
