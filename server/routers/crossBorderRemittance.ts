...
const CORRIDORS = [
  { from: "NGN", to: "GHS", rate: 0.0076, name: "Nigeria to Ghana", active: true },
  { from: "NGN", to: "KES", rate: 0.088, name: "Nigeria to Kenya", active: true },
  { from: "NGN", to: "ZAR", rate: 0.012, name: "Nigeria to South Africa", active: true },
  { from: "NGN", to: "USD", rate: 0.00065, name: "Nigeria to USA", active: true },
  { from: "NGN", to: "GBP", rate: 0.00052, name: "Nigeria to UK", active: true },
  { from: "NGN", to: "EUR", rate: 0.00060, name: "Nigeria to EU", active: true },
  { from: "NGN", to: "XOF", rate: 0.39, name: "Nigeria to West Africa (CFA)", active: true },
];
