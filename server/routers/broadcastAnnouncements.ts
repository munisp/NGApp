...
const seedData = [
  ...
  },
  {
    ...
    pinned: true,
    channels: ["banner", "inbox", "push"],
  },
  {
    id: "ann_004",
    title: "Rate Change",
    type: "warning" as const,
    target: "merchants" as const,
    pinned: false,
    channels: ["inbox"],
  },
  {
...
export const broadcastAnnouncementsRouter = router({
  ...
  create: protectedProcedure
    .input(
      z.object({
        ...
        target: z.enum(TARGET_AUDIENCES),
  ...
  stats: protectedProcedure.query(async () => {
    return {
      ...
      pinned: seedData.filter(a => a.pinned).length,
      byType: { info: 1, warning: 1, critical: 1, maintenance: 1, feature: 1 },
    };
  }),
});
