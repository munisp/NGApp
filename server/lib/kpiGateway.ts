...
const ROLE_METRICS: Record<string, Array<Omit<KPIMetric, "value" | "status">>> = {
  ...
  compliance: [
    { id: "cmp_kyc_pending", name: "KYC Pending", target: 50, unit: "count", weight: 0.20, cadence: "hourly", description: "Awaiting verification" },
    { id: "cmp_ctr_filing", name: "CTR Filing (₦5M+)", target: 100, unit: "%", weight: 0.25, cadence: "daily", description: "Filed within 24hrs" },
    { id: "cmp_sar_backlog", name: "SAR Backlog", target: 0, unit: "count", weight: 0.25, cadence: "daily", description: "Overdue SARs" },
    { id: "cmp_kyc_tier", name: "KYC Tier Compliance", target: 100, unit: "%", weight: 0.20, cadence: "daily", description: "Correct tier %" },
    { id: "cmp_expired_docs", name: "Expired Documents", target: 0, unit: "count", weight: 0.10, cadence: "hourly", description: "Active with expired ID" },
  ],
  customer_service: [
