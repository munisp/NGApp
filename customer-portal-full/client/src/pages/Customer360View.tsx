        ...
        <CardContent className="grid gap-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p><strong>Active Policies:</strong> {profileData.policies.filter(p => p.status === 'Active').length}</p>
              <p><strong>Total Claims:</strong> {profileData.claims.length}</p>
              <p><strong>Loyalty Points:</strong> {profileData.loyaltyPoints}</p>
