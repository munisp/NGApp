...
export default function MerchantRiskScoring() {
  ...
  const { data: _liveData } = trpc.merchantRiskScoring.list.useQuery(undefined, { retry: 1 });
      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Manage and monitor merchant risk scoring operations</p>
          </div>
