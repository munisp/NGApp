...
export default function ReportTemplateDesigner() {
  ...
  const { data: templatesData, isLoading } = trpc.reportTemplate.list.useQuery({ search: search || undefined });
                ...
                {templates.map((t: any) => (
                  <Card key={t.id} className="hover:border-primary/30 transition-colors">
                    ...
                    <CardFooter className="pt-2 gap-2">
                      ...
                      {!t.isDefault && (
                        <Button size="sm" variant="outline" onClick={() => setDefaultMutation.mutate({ id: t.id })}>
