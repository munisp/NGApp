...
export default function MultiTenantIsolation() {
  ...
  const { data: _liveData } = trpc.multiTenantIsolation.list.useQuery(undefined, { retry: 1 });
      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Manage and monitor multi tenant isolation operations</p>
          </div>
