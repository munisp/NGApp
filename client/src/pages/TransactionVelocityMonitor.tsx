...
export default function TransactionVelocityMonitor() {
  ...
  const { data: _liveData } = trpc.transactionVelocityMonitor.list.useQuery(undefined, { retry: 1 });
      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Manage and monitor transaction velocity monitor operations</p>
          </div>
