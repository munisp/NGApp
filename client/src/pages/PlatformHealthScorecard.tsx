...
export default function PlatformHealthScorecard() {
  ...
  const { data: liveData, isLoading } = trpc.platformHealthScorecard.list.useQuery(
    undefined,
    { retry: 1 }
  );
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">Composite health index across all subsystems</p>
          </div>
