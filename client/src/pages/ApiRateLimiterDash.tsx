...
export default function ApiRateLimiterDash() {
  ...
  const { data, isLoading } = trpc.rateLimitDashboard.getStatus.useQuery({ page: 1, limit: 10 });
      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Manage and monitor api rate limiter dash operations</p>
          </div>
