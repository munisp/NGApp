      ...
      <div className="rounded-lg border border-border bg-card">
        <div className="px-6 py-8">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div><div className="text-xs text-primary font-mono uppercase tracking-widest">GAID Art. 28</div><h1 className="text-xl font-bold text-foreground">Data Protection Impact Assessments</h1></div>
          </div>
