        ...
        <div className="p-4 border-t border-border/40 shrink-0">
          <div className="flex gap-2">
            <input
              ...
              disabled={isLoading}
              className="flex-1 bg-muted/40 border border-border/60 rounded-lg px-3 py-2 text-sm mono placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary/40 disabled:opacity-50"
            />
            <button
              onClick={() => handleSend()}
