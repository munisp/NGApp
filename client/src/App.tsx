...
const ReminderEmailManagement = lazy(() => import("./pages/admin/ReminderEmailManagement"));
...
const TechnicalOnboardingReview = lazy(() => import("@/pages/admin/TechnicalOnboardingReview"));
const NotificationPreferences = lazy(() => import("@/pages/admin/NotificationPreferences"));
const IntegrationDevelopment = lazy(() => import("@/pages/onboarding/IntegrationDevelopment"));
const SharedComparisonView = lazy(() => import("@/pages/onboarding/SharedComparisonView"));
const RemittanceDemo = lazy(() => import("@/pages/RemittanceDemo"));
const RemittanceAdminDashboard = lazy(() => import("@/pages/RemittanceAdminDashboard"));
