...
# Configuration
SCREENING_PROVIDER = os.getenv("SCREENING_PROVIDER", "mock")  # mock, comply_advantage, dow_jones, refinitiv
...
def get_screening_provider() -> ScreeningProvider:
    ...
    if provider == "comply_advantage":
        ...
        logger.warning(f"Unknown screening provider: {provider}, using mock")
        return MockScreeningProvider()
