...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path == "/healthz":
            self.respond(200, {
                "service": "ndpr-compliance-py", "status": "healthy", "version": "2.0.0",
                "uptime_secs": int(time.time() - START_TIME),
                "domain": "Ndpr Compliance — Regulatory",
                "middleware": {
                    "kafka": "ndpr-compliance.events, ndpr-compliance.audit",
                    "postgres": "ndpr_compliance_records",
                    "redis": "ndpr-compliance_cache",
                    "temporal": "NdprComplianceWorkflow",
                    "permify": "ndpr-compliance:manage, ndpr-compliance:view",
                    "opensearch": "ndpr-compliance-2026",
                },
            })
        ...
        elif path == "/v1/ndpr-compliance/audit":
...
if __name__ == "__main__":
    ...
    print(f"Ndpr Compliance v2.0 (Regulatory) on :{port}")
