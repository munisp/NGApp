...
func handleHealthz(w http.ResponseWriter, r *http.Request) {
	respondJSON(w, 200, map[string]interface{}{
		"service": "loan-origination-go", "status": "healthy", "version": "2.0.0",
		...
		"middleware": map[string]string{
			...
			"permify":    "loan-origination:manage, loan-origination:view",
...
func main() {
	...
	log.Printf("Loan Origination v2.0 (Lending) on :%s", port)
