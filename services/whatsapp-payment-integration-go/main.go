// whatsapp-payment-integration-go — Domain-specific microservice with full protocol implementation
package main
...
func handleHealthz(w http.ResponseWriter, r *http.Request) {
	respondJSON(w, 200, map[string]interface{}{
		...
		"domain": "Whatsapp Payment Integration",
		"middleware": map[string]string{
			...
			"permify": "whatsapp-payment-integration.manage",
...
func handleList(w http.ResponseWriter, r *http.Request) {
	...
	}, "total": 3, "domain": "Whatsapp Payment Integration"})
}
...
func main() {
	...
	log.Printf("Whatsapp Payment Integration Service (Go) on :%s", port)
