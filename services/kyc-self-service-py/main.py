#!/usr/bin/env python3
"""Kyc Self Service — Domain-specific Python microservice
...
class Handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        if path in ("/healthz", "/health"):
            self._json(200, {"service": "kyc-self-service-py", "status": "healthy", "domain": "Kyc Self Service",
                "middleware": {"kafka": "kyc-self-service.events", "postgres": "kyc_self_service_records", "redis": "kyc-self-service_cache", "temporal": "KycSelfServiceWorkflow"}})
...
if __name__ == "__main__":
    logging.info(f"Kyc Self Service (Python) on :{PORT}")
