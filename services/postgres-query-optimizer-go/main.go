// postgres-query-optimizer-go — Production-hardened service
package main
...
func main() {
	...
	http.HandleFunc("/v1/postgres-query-optimizer/list", handleList)
	http.HandleFunc("/v1/postgres-query-optimizer/create", handleCreate)
	http.HandleFunc("/v1/postgres-query-optimizer/update", handleUpdate)
	http.HandleFunc("/v1/postgres-query-optimizer/process", handleProcess)
	http.HandleFunc("/v1/postgres-query-optimizer/audit", handleAudit)
	http.HandleFunc("/v1/postgres-query-optimizer/stats", handleStats)
	http.HandleFunc("/v1/postgres-query-optimizer/score", postgres_query_optimizerScoreHandler)
	http.HandleFunc("/v1/postgres-query-optimizer/validate", postgres_query_optimizerValidateRequestHandler)
...
fmt.Fprintf(w, "requests_total{service=\"postgres-query-optimizer-go\"} %d\n", reqs)
fmt.Fprintf(w, "# HELP errors_total Total errors\n")
fmt.Fprintf(w, "# TYPE errors_total counter\n")
fmt.Fprintf(w, "errors_total{service=\"postgres-query-optimizer-go\"} %d\n", errs)
}
...
mux.HandleFunc("/v1/create", authMiddleware(createHandler))
	...
	mux.HandleFunc("/v1/postgres-query-optimizer/list", authMiddleware(handleList))
	mux.HandleFunc("/v1/postgres-query-optimizer/create", authMiddleware(handleCreate))
	mux.HandleFunc("/v1/postgres-query-optimizer/update", authMiddleware(handleUpdate))
	mux.HandleFunc("/v1/postgres-query-optimizer/process", authMiddleware(handleProcess))
	mux.HandleFunc("/v1/postgres-query-optimizer/audit", authMiddleware(handleAudit))
	mux.HandleFunc("/v1/postgres-query-optimizer/stats", authMiddleware(handleStats))
	mux.HandleFunc("/v1/postgres-query-optimizer/score", authMiddleware(postgres_query_optimizerScoreHandler))
	mux.HandleFunc("/v1/postgres-query-optimizer/validate", authMiddleware(postgres_query_optimizerValidateRequestHandler))
...
go func() {
    log.Println(jsonLog("INFO", fmt.Sprintf("postgres-query-optimizer-go listening on :%s", port)))
