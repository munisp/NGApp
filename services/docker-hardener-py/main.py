...
class Handler(BaseHTTPRequestHandler):
    ...
    def respond(self, code, data):
        ...
        self.send_header("X-Service", "docker-hardener-py")
        self.end_headers()
    ...
    def do_GET(self):
        ...
        if path == "/healthz":
            self.respond(200, {
                "service": "docker-hardener-py", "status": "healthy", "version": "2.0.0",
                "uptime_secs": int(time.time() - START_TIME),
                "domain": "Docker Hardener — Infrastructure/Ops",
                "middleware": {
                    "kafka": "docker-hardener.events, docker-hardener.audit",
                    "postgres": "docker_hardener_records",
                    "redis": "docker-hardener_cache",
                    "temporal": "DockerHardenerWorkflow",
                    "permify": "docker-hardener:manage, docker-hardener:view",
                    "opensearch": "docker-hardener-2026",
                },
            })
        elif path == "/v1/docker-hardener/list":
        ...
        elif path == "/v1/docker-hardener/audit":
            self.respond(200, {"audit_log": audit_log, "total": len(audit_log)})
        elif path == "/v1/docker-hardener/stats":
    ...
    def do_POST(self):
        ...
        if path == "/v1/docker-hardener/create":
            rec = {
...
if __name__ == "__main__":
    ...
    print(f"Docker Hardener v2.0 (Infrastructure/Ops) on :{port}")
