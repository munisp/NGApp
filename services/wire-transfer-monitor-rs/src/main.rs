...
async fn list_records() -> HttpResponse {
    HttpResponse::Ok().json(json!({"records": [
        {"id": "REC-001", "status": "active", "domain": "Wire Transfer Monitor", "createdAt": "2026-05-09T10:00:00Z"},
        {"id": "REC-002", "status": "processing", "domain": "Wire Transfer Monitor", "createdAt": "2026-05-09T11:00:00Z"},
        {"id": "REC-003", "status": "completed", "domain": "Wire Transfer Monitor", "createdAt": "2026-05-08T14:00:00Z"},
    ], "total": 3, "domain": "Wire Transfer Monitor"}))
}
