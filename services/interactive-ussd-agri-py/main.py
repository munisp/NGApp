#!/usr/bin/env python3
"""Interactive Ussd Agri — Domain-specific Python microservice
...
PORT = int(os.environ.get("PORT", "9429"))
...
class Handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        if path in ("/healthz", "/health"):
            self._json(200, {"service": "interactive-ussd-agri-py", "status": "healthy", "domain": "Interactive Ussd Agri",
                "middleware": {"kafka": "interactive-ussd-agri.events", "postgres": "interactive_ussd_agri_records", "redis": "interactive-ussd-agri_cache", "temporal": "InteractiveUssdAgriWorkflow"}})
...
if __name__ == "__main__":
    logging.info(f"Interactive Ussd Agri (Python) on :{PORT}")
