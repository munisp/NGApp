// leasing-go — Domain-specific microservice with full protocol implementation
package main
...
func main() {
	...
	log.Printf("Leasing Service (Go) on :%s", port)
