// temporal-sagas-go — Domain-specific microservice with full protocol implementation
package main
...
func handleList(w http.ResponseWriter, r *http.Request) {
	respondJSON(w, 200, map[string]interface{}{"records": []map[string]interface{}{
		{"id": "REC-001", "type": "active", "status": "operational", "createdAt": "2026-05-09T10:00:00Z", "metadata": map[string]interface{}{"domain": "Temporal Sagas", "version": "2.0.0"}},
...
func main() {
	...
	log.Printf("Temporal Sagas Service (Go) on :%s", port)
