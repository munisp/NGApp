// agri-logistics-go — Domain-specific microservice with full protocol implementation
package main
...
func main() {
	...
	log.Printf("Agri Logistics Service (Go) on :%s", port)
