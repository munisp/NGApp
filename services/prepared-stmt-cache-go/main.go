// prepared-stmt-cache-go — Domain-specific microservice with full protocol implementation
package main
...
func handleHealthz(w http.ResponseWriter, r *http.Request) {
	respondJSON(w, 200, map[string]interface{}{
		...
		"middleware": map[string]string{
			...
			"permify": "prepared-stmt-cache.manage",
...
func handleList(w http.ResponseWriter, r *http.Request) {
	...
	}, "total": 3, "domain": "Prepared Stmt Cache"})
}
...
func main() {
	...
	log.Printf("Prepared Stmt Cache Service (Go) on :%s", port)
