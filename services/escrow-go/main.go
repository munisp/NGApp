// escrow-go — Domain-specific microservice with full protocol implementation
package main
...
func main() {
	...
	log.Printf("Escrow Service (Go) on :%s", port)
