#!/usr/bin/env python3
"""Gnn Fraud Detection — Domain-specific Python microservice
...
PORT = int(os.environ.get("PORT", "9427"))
...
class Handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        if path in ("/healthz", "/health"):
            self._json(200, {"service": "gnn-fraud-detection-py", "status": "healthy", "domain": "Gnn Fraud Detection",
                "middleware": {"kafka": "gnn-fraud-detection.events", "postgres": "gnn_fraud_detection_records", "redis": "gnn-fraud-detection_cache", "temporal": "GnnFraudDetectionWorkflow"}})
...
if __name__ == "__main__":
    logging.info(f"Gnn Fraud Detection (Python) on :{PORT}")
