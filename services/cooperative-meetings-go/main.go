// cooperative-meetings-go — Domain-specific microservice with full protocol implementation
package main
...
func handleHealthz(w http.ResponseWriter, r *http.Request) {
	respondJSON(w, 200, map[string]interface{}{
		...
		"middleware": map[string]string{
			...
			"permify": "cooperative-meetings.manage",
...
func handleList(w http.ResponseWriter, r *http.Request) {
	...
	}, "total": 3, "domain": "Cooperative Meetings"})
}
...
func main() {
	...
	log.Printf("Cooperative Meetings Service (Go) on :%s", port)
