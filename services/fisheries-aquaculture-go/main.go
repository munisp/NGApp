// fisheries-aquaculture-go — Domain-specific microservice with full protocol implementation
package main
...
func handleHealthz(w http.ResponseWriter, r *http.Request) {
	respondJSON(w, 200, map[string]interface{}{
		...
		"middleware": map[string]string{
			...
			"permify": "fisheries-aquaculture.manage",
...
func handleList(w http.ResponseWriter, r *http.Request) {
	...
	}, "total": 3, "domain": "Fisheries Aquaculture"})
}
...
func main() {
	...
	log.Printf("Fisheries Aquaculture Service (Go) on :%s", port)
