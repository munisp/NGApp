...
class Handler(BaseHTTPRequestHandler):
    ...
    def respond(self, code, data):
        ...
        self.send_header("X-Service", "siem-exporter-py")
        self.end_headers()
    ...
    def do_GET(self):
        ...
        if path == "/healthz":
            self.respond(200, {
                "service": "siem-exporter-py", "status": "healthy", "version": "2.0.0",
                "uptime_secs": int(time.time() - START_TIME),
                "domain": "Siem Exporter — Testing/Observability",
                "middleware": {
                    "kafka": "siem-exporter.events, siem-exporter.audit",
                    "postgres": "siem_exporter_records",
                    "redis": "siem-exporter_cache",
                    "temporal": "SiemExporterWorkflow",
                    "permify": "siem-exporter:manage, siem-exporter:view",
                    "opensearch": "siem-exporter-2026",
                },
            })
        ...
        elif path == "/v1/siem-exporter/audit":
...
if __name__ == "__main__":
    ...
    print(f"Siem Exporter v2.0 (Testing/Observability) on :{port}")
