// voice-ivr-menu-go — Domain-specific microservice with full protocol implementation
package main
...
func main() {
	...
	log.Printf("Voice Ivr Menu Service (Go) on :%s", port)
