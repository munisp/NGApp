// beneficiary-management-go — Production-hardened service
package main
...
func main() {
	...
	http.HandleFunc("/v1/beneficiary-management/list", handleList)
	http.HandleFunc("/v1/beneficiary-management/create", handleCreate)
	http.HandleFunc("/v1/beneficiary-management/update", handleUpdate)
	http.HandleFunc("/v1/beneficiary-management/process", handleProcess)
	http.HandleFunc("/v1/beneficiary-management/audit", handleAudit)
	http.HandleFunc("/v1/beneficiary-management/stats", handleStats)
	http.HandleFunc("/v1/beneficiary-management/score", beneficiary_managementScoreHandler)
	http.HandleFunc("/v1/beneficiary-management/validate", beneficiary_managementValidateRequestHandler)
...
fmt.Fprintf(w, "requests_total{service=\"beneficiary-management-go\"} %d\n", reqs)
fmt.Fprintf(w, "# HELP errors_total Total errors\n")
fmt.Fprintf(w, "# TYPE errors_total counter\n")
fmt.Fprintf(w, "errors_total{service=\"beneficiary-management-go\"} %d\n", errs)
}
...
mux.HandleFunc("/v1/create", authMiddleware(createHandler))
	...
	mux.HandleFunc("/v1/beneficiary-management/list", authMiddleware(handleList))
	mux.HandleFunc("/v1/beneficiary-management/create", authMiddleware(handleCreate))
	mux.HandleFunc("/v1/beneficiary-management/update", authMiddleware(handleUpdate))
	mux.HandleFunc("/v1/beneficiary-management/process", authMiddleware(handleProcess))
	mux.HandleFunc("/v1/beneficiary-management/audit", authMiddleware(handleAudit))
	mux.HandleFunc("/v1/beneficiary-management/stats", authMiddleware(handleStats))
	mux.HandleFunc("/v1/beneficiary-management/score", authMiddleware(beneficiary_managementScoreHandler))
	mux.HandleFunc("/v1/beneficiary-management/validate", authMiddleware(beneficiary_managementValidateRequestHandler))
...
go func() {
    log.Println(jsonLog("INFO", fmt.Sprintf("beneficiary-management-go listening on :%s", port)))
