...
class Handler(BaseHTTPRequestHandler):
    ...
    def respond(self, code, data):
        ...
        self.send_header("X-Service", "bundle-splitter-py")
        self.end_headers()
    ...
    def do_GET(self):
        ...
        if path == "/healthz":
            self.respond(200, {
                "service": "bundle-splitter-py", "status": "healthy", "version": "2.0.0",
                "uptime_secs": int(time.time() - START_TIME),
                "domain": "Bundle Splitter — Infrastructure/Ops",
                "middleware": {
                    "kafka": "bundle-splitter.events, bundle-splitter.audit",
                    "postgres": "bundle_splitter_records",
                    "redis": "bundle-splitter_cache",
                    "temporal": "BundleSplitterWorkflow",
                    "permify": "bundle-splitter:manage, bundle-splitter:view",
                    "opensearch": "bundle-splitter-2026",
                },
            })
        elif path == "/v1/bundle-splitter/list":
        ...
        elif path == "/v1/bundle-splitter/audit":
            self.respond(200, {"audit_log": audit_log, "total": len(audit_log)})
        elif path == "/v1/bundle-splitter/stats":
    ...
    def do_POST(self):
        ...
        if path == "/v1/bundle-splitter/create":
            rec = {
...
if __name__ == "__main__":
    ...
    print(f"Bundle Splitter v2.0 (Infrastructure/Ops) on :{port}")
