// salary-processing-go — Domain-specific microservice with full protocol implementation
package main
...
func handleHealthz(w http.ResponseWriter, r *http.Request) {
	respondJSON(w, 200, map[string]interface{}{
		...
		"middleware": map[string]string{
			...
			"permify": "salary-processing.manage",
...
func handleList(w http.ResponseWriter, r *http.Request) {
	...
	}, "total": 3, "domain": "Salary Processing"})
}
...
func main() {
	...
	log.Printf("Salary Processing Service (Go) on :%s", port)
