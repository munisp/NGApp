#!/usr/bin/env python3
"""Crop Yield Prediction — Domain-specific Python microservice
...
PORT = int(os.environ.get("PORT", "9418"))
...
class Handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        if path in ("/healthz", "/health"):
            self._json(200, {"service": "crop-yield-prediction-py", "status": "healthy", "domain": "Crop Yield Prediction",
                "middleware": {"kafka": "crop-yield-prediction.events", "postgres": "crop_yield_prediction_records", "redis": "crop-yield-prediction_cache", "temporal": "CropYieldPredictionWorkflow"}})
...
if __name__ == "__main__":
    logging.info(f"Crop Yield Prediction (Python) on :{PORT}")
