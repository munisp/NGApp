// agri-evoucher-go — Domain-specific microservice with full protocol implementation
package main
...
func main() {
	...
	log.Printf("Agri Evoucher Service (Go) on :%s", port)
