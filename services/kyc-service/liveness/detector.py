...
class LivenessDetector:
    ...
    def _anti_spoof_analysis(self, img: "np.ndarray", points: "np.ndarray") -> float:
        """Multi-signal anti-spoofing analysis.

        Combines:
        1. Texture analysis (LBP variance for print detection)
        2. Depth consistency from face geometry
