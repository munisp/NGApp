"""54Bank Video KYC service — AI analysis, geo-fencing, compliance recording
...
def middleware_config():
    return {
        ...
        "keycloak": {"url": os.getenv("KEYCLOAK_URL", "http://localhost:8080"), "realm": "54bank", "client_id": "video-kyc-py"},
