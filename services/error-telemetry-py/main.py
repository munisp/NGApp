...
class Handler(BaseHTTPRequestHandler):
    ...
    def respond(self, code, data):
        ...
        self.send_header("X-Service", "error-telemetry-py")
        self.end_headers()
    ...
    def do_GET(self):
        ...
        if path == "/healthz":
            self.respond(200, {
                "service": "error-telemetry-py", "status": "healthy", "version": "2.0.0",
                "uptime_secs": int(time.time() - START_TIME),
                "domain": "Error Telemetry — Testing/Observability",
                "middleware": {
                    "kafka": "error-telemetry.events, error-telemetry.audit",
                    "postgres": "error_telemetry_records",
                    "redis": "error-telemetry_cache",
                    "temporal": "ErrorTelemetryWorkflow",
                    "permify": "error-telemetry:manage, error-telemetry:view",
                    "opensearch": "error-telemetry-2026",
                },
            })
        ...
        elif path == "/v1/error-telemetry/audit":
...
if __name__ == "__main__":
    ...
    print(f"Error Telemetry v2.0 (Testing/Observability) on :{port}")
