"""54Bank Load Test Runner — Python
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path == "/healthz":
            self.respond(200, {
                "service": "load-test-runner-py", "status": "healthy", "version": "2.0.0",
                "uptime_secs": int(time.time() - START_TIME),
                "domain": "Load Test Runner — Testing/Observability",
                "middleware": {
                    "kafka": "load-test-runner.events, load-test-runner.audit",
                    "postgres": "load_test_runner_records",
                    "redis": "load-test-runner_cache",
                    "temporal": "LoadTestRunnerWorkflow",
                    "permify": "load-test-runner:manage, load-test-runner:view",
                    "opensearch": "load-test-runner-2026",
                },
            })
        ...
        elif path == "/v1/load-test-runner/audit":
...
if __name__ == "__main__":
    ...
    print(f"Load Test Runner v2.0 (Testing/Observability) on :{port}")
