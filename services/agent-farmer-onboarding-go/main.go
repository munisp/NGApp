// agent-farmer-onboarding-go — Domain-specific microservice with full protocol implementation
package main
...
func handleHealthz(w http.ResponseWriter, r *http.Request) {
	respondJSON(w, 200, map[string]interface{}{
		...
		"domain": "Agent Farmer Onboarding",
		"middleware": map[string]string{
			...
			"permify": "agent-farmer-onboarding.manage",
...
func handleList(w http.ResponseWriter, r *http.Request) {
	...
	}, "total": 3, "domain": "Agent Farmer Onboarding"})
}
...
func main() {
	...
	log.Printf("Agent Farmer Onboarding Service (Go) on :%s", port)
