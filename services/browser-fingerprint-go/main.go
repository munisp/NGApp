// browser-fingerprint-go — Domain-specific microservice with full protocol implementation
package main
...
func handleHealthz(w http.ResponseWriter, r *http.Request) {
	respondJSON(w, 200, map[string]interface{}{
		...
		"middleware": map[string]string{
			...
			"permify": "browser-fingerprint.manage",
...
func handleList(w http.ResponseWriter, r *http.Request) {
	...
	}, "total": 3, "domain": "Browser Fingerprint"})
}
...
func main() {
	...
	log.Printf("Browser Fingerprint Service (Go) on :%s", port)
