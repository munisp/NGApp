// kafka-schema-registry-go — Domain-specific microservice with full protocol implementation
package main
...
func handleHealthz(w http.ResponseWriter, r *http.Request) {
	respondJSON(w, 200, map[string]interface{}{
		...
		"middleware": map[string]string{
			...
			"permify": "kafka-schema-registry.manage",
...
func handleList(w http.ResponseWriter, r *http.Request) {
	...
	}, "total": 3, "domain": "Kafka Schema Registry"})
}
...
func main() {
	...
	log.Printf("Kafka Schema Registry Service (Go) on :%s", port)
