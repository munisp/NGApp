...
def process_request(action, params):
    """Process domain-specific request for exam-management"""
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path == "/healthz":
            self.respond(200, {
                "service": "exam-management-py", "status": "healthy", "version": "2.0.0",
                "uptime_secs": int(time.time() - START_TIME),
                "domain": "Exam Management — Platform",
                "middleware": {
                    "kafka": "exam-management.events, exam-management.audit",
                    "postgres": "exam_management_records",
                    "redis": "exam-management_cache",
                    "temporal": "ExamManagementWorkflow",
                    "permify": "exam-management:manage, exam-management:view",
                    "opensearch": "exam-management-2026",
                },
            })
        ...
        elif path == "/v1/exam-management/audit":
    ...
    def do_POST(self):
        ...
        if path == "/v1/exam-management/create":
            rec = {
...
if __name__ == "__main__":
    ...
    print(f"Exam Management v2.0 (Platform) on :{port}")
