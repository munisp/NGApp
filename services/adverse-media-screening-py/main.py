#!/usr/bin/env python3
"""Adverse Media Screening — Domain-specific Python microservice
...
class Handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        if path in ("/healthz", "/health"):
            self._json(200, {"service": "adverse-media-screening-py", "status": "healthy", "domain": "Adverse Media Screening",
                "middleware": {"kafka": "adverse-media-screening.events", "postgres": "adverse_media_screening_records", "redis": "adverse-media-screening_cache", "temporal": "AdverseMediaScreeningWorkflow"}})
...
if __name__ == "__main__":
    logging.info(f"Adverse Media Screening (Python) on :{PORT}")
