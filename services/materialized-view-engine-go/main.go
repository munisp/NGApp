// materialized-view-engine-go — Domain-specific microservice with full protocol implementation
package main
...
func handleHealthz(w http.ResponseWriter, r *http.Request) {
	respondJSON(w, 200, map[string]interface{}{
		...
		"domain": "Materialized View Engine",
		"middleware": map[string]string{
			...
			"permify": "materialized-view-engine.manage",
...
func handleList(w http.ResponseWriter, r *http.Request) {
	...
	}, "total": 3, "domain": "Materialized View Engine"})
}
...
func main() {
	...
	log.Printf("Materialized View Engine Service (Go) on :%s", port)
