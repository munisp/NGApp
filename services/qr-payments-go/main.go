// qr-payments-go — Domain-specific microservice with full protocol implementation
package main
...
func main() {
	...
	log.Printf("Qr Payments Service (Go) on :%s", port)
