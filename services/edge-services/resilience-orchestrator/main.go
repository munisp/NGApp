	...
	contacts := []*EmergencyContact{
		{
			...
			Organization: "Agent Banking Network",
			Phone:        []string{"+234-800-123-4567", "+234-901-234-5678"},
			Email:        []string{"emergency@agentbanking.com", "john.doe@agentbanking.com"},
			Priority:     1,
			Availability: "24x7",
		...
		},
		{
			...
			Email:        []string{"technical@agentbanking.com", "jane.smith@agentbanking.com"},
			Priority:     2,
