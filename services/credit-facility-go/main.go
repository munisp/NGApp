// credit-facility-go — Domain-specific microservice with full protocol implementation
package main
...
func handleHealthz(w http.ResponseWriter, r *http.Request) {
	respondJSON(w, 200, map[string]interface{}{
		...
		"middleware": map[string]string{
			...
			"permify": "credit-facility.manage",
...
func handleList(w http.ResponseWriter, r *http.Request) {
	...
	}, "total": 3, "domain": "Credit Facility"})
}
...
func main() {
	...
	log.Printf("Credit Facility Service (Go) on :%s", port)
