// keda-scaler-go — Domain-specific microservice with full protocol implementation
package main
...
func main() {
	...
	log.Printf("Keda Scaler Service (Go) on :%s", port)
