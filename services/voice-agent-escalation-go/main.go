// voice-agent-escalation-go — Domain-specific microservice with full protocol implementation
package main
...
func handleHealthz(w http.ResponseWriter, r *http.Request) {
	respondJSON(w, 200, map[string]interface{}{
		...
		"middleware": map[string]string{
			...
			"permify": "voice-agent-escalation.manage",
...
func handleList(w http.ResponseWriter, r *http.Request) {
	...
	}, "total": 3, "domain": "Voice Agent Escalation"})
}
...
func main() {
	...
	log.Printf("Voice Agent Escalation Service (Go) on :%s", port)
