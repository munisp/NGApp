// mandate-management-go — Domain-specific microservice with full protocol implementation
package main
...
func handleHealthz(w http.ResponseWriter, r *http.Request) {
	respondJSON(w, 200, map[string]interface{}{
		...
		"middleware": map[string]string{
			...
			"permify": "mandate-management.manage",
...
func handleList(w http.ResponseWriter, r *http.Request) {
	respondJSON(w, 200, map[string]interface{}{"records": []map[string]interface{}{
		{"id": "REC-001", "type": "active", "status": "operational", "createdAt": "2026-05-09T10:00:00Z", "metadata": map[string]interface{}{"domain": "Mandate Management", "version": "2.0.0"}},
	...
	}, "total": 3, "domain": "Mandate Management"})
}
...
func main() {
	...
	log.Printf("Mandate Management Service (Go) on :%s", port)
